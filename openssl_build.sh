...
ANDROID_NDK_PATH=${WORK_PATH}/android-ndk-r25
...
then
    ...
    ./Configure android-arm --release -static no-autoalginit no-autoerrinit no-autoload-config no-err no-filenames no-shared no-stdio no-tests no-ui-console --prefix=${OUTPUT_PATH}
    build_library
...
then
    ...
    PATH=$ANDROID_NDK_ROOT/toolchains/llvm/prebuilt/linux-x86_64/bin:$ANDROID_NDK_ROOT/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin:$ANDROID_NDK_ROOT/toolchains/aarch64-linux-android-4.9/prebuilt/linux-x86_64/bin:$PATH
    cd ${OPENSSL_TMP_FOLDER}
    ./Configure android-arm64 --release -static no-autoalginit no-autoerrinit no-autoload-config no-err no-filenames no-shared no-stdio no-tests no-ui-console --prefix=${OUTPUT_PATH}
    build_library
...
then
    ...
    PATH=$ANDROID_NDK_ROOT/toolchains/llvm/prebuilt/linux-x86_64/bin:$ANDROID_NDK_ROOT/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin:$ANDROID_NDK_ROOT/toolchains/aarch64-linux-android-4.9/prebuilt/linux-x86_64/bin:$PATH
    cd ${OPENSSL_TMP_FOLDER}
    ./Configure android-x86 --release -static no-autoalginit no-autoerrinit no-autoload-config no-err no-filenames no-shared no-stdio no-tests no-ui-console --prefix=${OUTPUT_PATH}
    build_library
...
then
    ...
    PATH=$ANDROID_NDK_ROOT/toolchains/llvm/prebuilt/linux-x86_64/bin:$ANDROID_NDK_ROOT/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin:$ANDROID_NDK_ROOT/toolchains/aarch64-linux-android-4.9/prebuilt/linux-x86_64/bin:$PATH
    cd ${OPENSSL_TMP_FOLDER}
    ./Configure android-x86_64 --release -static no-autoalginit no-autoerrinit no-autoload-config no-err no-filenames no-shared no-stdio no-tests no-ui-console --prefix=${OUTPUT_PATH}
    build_library
